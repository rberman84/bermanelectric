  ...
  return (
    <div className="min-h-[100svh] overflow-x-hidden flex flex-col">
      <SEO
        ...
        description={`Trusted licensed electrician serving Long Island, Suffolk County & Ronkonkoma NY. 20+ years experience in residential & commercial electrical services. Emergency repairs, panel upgrades, EV charger installation. Call ${displayNumber}`}
