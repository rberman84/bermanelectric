...
const Commercial = () => {
  const services = [{
    ...
    items: [
      "Complete wiring for new commercial builds & renovations",
      "Electrical panel upgrades to meet increased power demands",
      "Dedicated circuits & electrical load balancing",
      "Office, warehouse, & retail electrical fit-outs"
    ]
  }, {
    title: "Lighting & Energy Efficiency Solutions",
    icon: <Lightbulb className="w-6 h-6 text-electric-600" />,
    items: [
      "Custom LED lighting installations for cost savings & sustainability",
      "Security & emergency lighting installation",
      "Motion sensors & automated lighting controls",
      "Parking lot lighting & exterior building illumination"
    ]
  }, {
    ...
    items: [
      ...
      "Repairing faulty outlets, switches, & power surges",
      "24/7 emergency electrical repairs to keep your business running"
    ]
  }, {
    ...
    items: [
      ...
      "Surge protection for sensitive commercial equipment"
    ]
  }, {
    title: "Code Compliance & Safety Inspections",
    icon: <Shield className="w-6 h-6 text-electric-600" />,
    items: [
      "Full commercial electrical safety inspections",
      "NEC compliance for permits & electrical certifications",
      "Fire alarm & smoke detector wiring",
      "GFCI & AFCI protection installations"
    ]
  }, {
    title: "Specialized Services",
    icon: <Factory className="w-6 h-6 text-electric-600" />,
    items: [
      "EV charging station installations for businesses",
      "Data cabling & structured wiring for offices & tech facilities",
      "Temporary power solutions for construction sites & events"
    ]
  }];
  ...
  const benefits = [
    "Over 20 Years of Commercial Experience – Trusted by top businesses across Long Island",
    "Licensed, Insured & Certified Electricians – Ensuring quality & safety",
    "Fast, Reliable, & Scalable Solutions – Minimize downtime & maximize efficiency",
    "Upfront Pricing & Custom Quotes – Competitive, transparent pricing with no hidden costs",
    "Emergency Service Available 24/7 – We're always ready when you need us"
  ];
