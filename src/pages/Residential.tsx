...
const Residential = () => {
  ...
  const metaDescription = `Professional residential electrical services on Long Island. Licensed electrician for home wiring, panel upgrades, lighting installation, EV chargers, smart home automation. Serving Suffolk & Nassau County. Call ${phoneDisplay}`;
