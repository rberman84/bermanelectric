  ...
  const services = [
    {
      ...
      items: [
        "Complete home wiring for new constructions & renovations",
        "Panel upgrades for improved electrical capacity",
    ...
    },
    {
      ...
      items: [
        "Fixing faulty outlets, switches, & wiring",
        "Power surges, flickering lights, & circuit issues",
    ...
    },
    {
      ...
      items: [
        ...
        "GFCI & AFCI outlet installations",
    ...
    },
    {
      ...
      items: [
        ...
        "Level 1, Level 2, & fast-charging solutions",
        "Permits, wiring, & panel upgrades for EV charging"
      ]
    },
    {
      ...
      items: [
        "Standby generator installation for uninterrupted power",
        "Transfer switches & whole-home power solutions",
        "Portable generator hookup & wiring"
      ]
    }
  ];

  const benefits = [
    "Over 20 Years of Experience – Trusted by homeowners across Long Island",
    "Licensed & Insured Electricians – Ensuring top-tier quality & safety",
    "Fast, Reliable Service – We get the job done right the first time",
    "Upfront Pricing – No hidden fees, just honest, competitive rates",
    "Customer Satisfaction Guaranteed – 5-star rated service"
  ];
          ...
          <div className="container relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {services.map((service, index) => (
                <div 
                  key={index}
                  className="card p-6 hover:translate-y-[-4px] bg-white/80 backdrop-blur-sm"
                >
