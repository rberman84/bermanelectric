            ...
            <>
              ...
              <div className="flex justify-center mb-8">
                <button
                  ...
                  className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-gradient-to-r from-[hsl(30,100%,50%)] to-[hsl(45,100%,50%)] text-white font-semibold text-lg shadow-lg hover:scale-105 transition-transform animate-pulse cursor-pointer"
                >
